...
function ContactForm() {
  ...
  return (
    ...
    //               <input type="text" id="form-name" name="name" className="form-control" placeholder="Please enter your first name"  value='firstName'/>
    ...
    //               <input type="text" id="form-name" name="name" className="form-control" placeholder="Please enter your last name" value='lastName'/>
    //               <div className="help-block with-errors"></div>
    //             </div>
    //           </div>
    //           <div className="col-md-6">
    ...
    //               <input type="email" id="form-email" name="email" className="form-control" placeholder="Please enter your email address" value='firstName' />
    //               <div className="help-block with-errors"></div>
    //             </div>
    //           </div>
    //           <div className="col-md-6">
